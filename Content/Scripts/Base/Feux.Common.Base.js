        ...
        if (!Feux.Base.Props.Device.touchDevice) {
            window.onresize = function (event) {
                ...
                Feux.Base.Props.Window.resizing = setTimeout(function () {
                    ...
                    if (Feux.Toast) { Feux.Toast.resize({ isOrientationChange: false, resizeCompleted: true }); }
            ...
            window.onorientationchange = function (event) {
                ...
                Feux.Base.Props.Window.resizing = setTimeout(function () {
                    ...
                    if (Feux.Toast) { Feux.Toast.resize({ isOrientationChange: true, resizeCompleted: true }); }
        ...
        events: function () {
            window.onscroll = function (event) {
                ...
                if (secondSection.length > 0) {
                    ...
                    var thirdSectionScrollTop = thirdSection[0].getBoundingClientRect().top;
                    var thirdSectionScrollBottom = thirdSection[0].getBoundingClientRect().bottom;
                    var fourthSection = document.getElementsByClassName("section-08");
